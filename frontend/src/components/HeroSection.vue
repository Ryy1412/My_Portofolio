...
Halo, Saya <span class="text-blue-600">Rayyis Hammam Mukhayyar</span>
</h1>
...
<!-- Badge Skill -->
    <div
        class="flex gap-3 mb-8 animate-slide-in-left"
        style="animation-delay: 500ms;"
    >
    <span
        class="bg-blue-100 text-blue-800 text-sm font-semibold px-3 py-1 rounded-full shadow-sm"
...
<img src='/src/assets/img/Rei.jpeg' alt="Foto Profil"
